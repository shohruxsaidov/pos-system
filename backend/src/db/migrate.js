...
async function seedDefaultUsers() {
  ...
  const defaultUsers = [
    { name: "Admin", pin: "5185", role: "admin" },
    { name: "Manager", pin: "5185", role: "manager" },
    { name: "Cashier 1", pin: "2000", role: "cashier" },
    { name: "Warehouse", pin: "5185", role: "warehouse" },
  ];

  db.prepare("INSERT OR IGNORE INTO warehouses (id, name) VALUES (1, ?)").run([
    "Main Warehouse",
  ]);
